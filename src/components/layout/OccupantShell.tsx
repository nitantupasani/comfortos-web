...
import { LayoutDashboard, Trees, Thermometer, MessageSquare, History, Settings, Building2, ArrowLeftRight, ChevronDown } from 'lucide-react';
...
const tabs = [
  ...
  { to: '/leaderboard', icon: Trees, label: 'Eco' },
